...
```bash
git clone https://github.com/satyam259/ai_artice_summarizer.git
...
Open [https://ai-artice-summarizer.vercel.app/](https://ai-artice-summarizer.vercel.app/) in your browser to view the project.
